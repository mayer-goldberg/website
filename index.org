...
- *Office hours* (for the *Spring Semester, 2026* ({{{rtl(סמסטר ב', תשפ"ו)}}}), currently *only* on [[https://us02web.zoom.us/j/86309317409?pwd=jHoMQ3Ec3xE35eLLPF5tuagZl7Swsm.1][Zoom]]:
  - For the [[./tc.html][/Teaching Committee/ ({{{rtl(ועדת הוראה\, אחראי על שנה א')}}})]]: Thursdays, 17-19
...
* Teaching
- /Introduction to Computer Architecture/, Spring 2026
